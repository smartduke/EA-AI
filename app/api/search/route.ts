...
function getFaviconUrl(domain: string): string {
  ...
  return getProxiedImageUrl(`https://www.google.com/s2/favicons?domain=${domain}&sz=128`);
}
...
const FALLBACK_NEWS: Record<string, SearchResult[]> = {
  'India': [
    {
      title: "India's Space Program Achieves New Milestone with Mars Mission Success",
      snippet: 'The Indian Space Research Organization (ISRO) successfully completed its second Mars mission, establishing a new research station.',
      url: 'https://www.thehindu.com/sci-tech/science/india-space-news',
      source: 'fallback',
      domain: 'thehindu.com',
      favicon: getProxiedImageUrl('https://www.google.com/s2/favicons?domain=thehindu.com&sz=128'),
      imageUrl: 'https://images.unsplash.com/photo-1614642264762-d0a3b8bf3700?q=80&w=1000&auto=format&fit=crop',
    },
    {
      title: 'New High-Speed Rail Line Connects Delhi to Mumbai in Record Time',
      snippet: 'The bullet train project has finally been completed, reducing travel time between the two major cities to just 3 hours.',
      url: 'https://indianexpress.com/article/india/rail-news',
      source: 'fallback',
      domain: 'indianexpress.com',
      favicon: getProxiedImageUrl('https://www.google.com/s2/favicons?domain=indianexpress.com&sz=128'),
      imageUrl: 'https://images.unsplash.com/photo-1540961016486-0ce04bef3b61?q=80&w=1000&auto=format&fit=crop',
    },
    {
      title: 'India GDP Growth Reaches 7.8%, Highest in Five Years',
      snippet: 'Economic experts attribute the growth to technology sector expansion and manufacturing investments.',
      url: 'https://economictimes.indiatimes.com/news/economy/india-economy-news',
      source: 'fallback',
      domain: 'economictimes.indiatimes.com',
      favicon: getProxiedImageUrl('https://www.google.com/s2/favicons?domain=economictimes.indiatimes.com&sz=128'),
      imageUrl: 'https://images.unsplash.com/photo-1542728109-15dac07bd87b?q=80&w=1000&auto=format&fit=crop',
    },
    {
      title: 'Mumbai Hosts International Film Festival with Record Attendance',
      snippet: 'The film festival attracted celebrities and filmmakers from around the globe, showcasing over 200 films.',
      url: 'https://timesofindia.indiatimes.com/entertainment/india-film-news',
      source: 'fallback',
      domain: 'timesofindia.indiatimes.com',
      favicon: getProxiedImageUrl('https://www.google.com/s2/favicons?domain=timesofindia.indiatimes.com&sz=128'),
      imageUrl: 'https://images.unsplash.com/photo-1626704348629-e4179eb9032f?q=80&w=1000&auto=format&fit=crop',
    },
  ],
  'default': [
    {
      title: 'Global Climate Summit Reaches Historic Agreement on Emissions',
      snippet: 'Over 190 countries have signed the new climate accord, pledging to reach carbon neutrality by 2050.',
      url: 'https://www.bbc.com/news/climate-news',
      source: 'fallback',
      domain: 'bbc.com',
      favicon: getProxiedImageUrl('https://www.google.com/s2/favicons?domain=bbc.com&sz=128'),
      imageUrl: 'https://images.unsplash.com/photo-1532947974358-a218d18d8d14?q=80&w=1000&auto=format&fit=crop',
    },
    {
      title: 'Breakthrough in Quantum Computing Announced by Research Team',
      snippet: 'Scientists have achieved quantum supremacy with a new 1000-qubit processor, solving previously impossible problems.',
      url: 'https://www.wired.com/tech-news',
      source: 'fallback',
      domain: 'wired.com',
      favicon: getProxiedImageUrl('https://www.google.com/s2/favicons?domain=wired.com&sz=128'),
      imageUrl: 'https://images.unsplash.com/photo-1629654291663-b91ad427698f?q=80&w=1000&auto=format&fit=crop',
    },
    {
      title: 'Global Economy Shows Signs of Recovery After Pandemic',
      snippet: 'IMF reports indicate stronger than expected growth across major economies as supply chains normalize.',
      url: 'https://www.economist.com/economy-news',
      source: 'fallback',
      domain: 'economist.com',
      favicon: getProxiedImageUrl('https://www.google.com/s2/favicons?domain=economist.com&sz=128'),
      imageUrl: 'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?q=80&w=1000&auto=format&fit=crop',
    },
    {
      title: 'Renewable Energy Installations Surpass Fossil Fuels for First Time',
      snippet: 'Solar and wind power now account for over 50% of new electricity generation capacity worldwide.',
      url: 'https://www.theguardian.com/energy-news',
      source: 'fallback',
      domain: 'theguardian.com',
      favicon: getProxiedImageUrl('https://www.google.com/s2/favicons?domain=theguardian.com&sz=128'),
      imageUrl: 'https://images.unsplash.com/photo-1509391618207-32f1db0bd0f6?q=80&w=1000&auto=format&fit=crop',
    },
  ]
};
...
export async function GET(request: NextRequest) {
  ...
  const countryMatch = query.match(/^(India|United States|UK|Japan|Australia|Canada|Germany|France|Spain|Brazil|Mexico)/i);
  ...
  try {
    ...
    const fallbackNews = (country && FALLBACK_NEWS[country]) || FALLBACK_NEWS['default'];
    console.log(`Error occurred, using fallback news (${country || 'default'})`);
    ...
    try {
      ...
      $('.result').each((_: number, element) => {
        ...
        if (titleElement.length) {
          ...
          if (imageUrl && (imageUrl.startsWith('data:') || imageUrl.includes('favicon') || imageUrl.length < 20)) {
            imageUrl = '';
          }
